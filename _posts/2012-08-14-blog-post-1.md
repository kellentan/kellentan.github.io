...
To get the marginal distribution from a joint distribution, simply sum or integrate over all values of our extra variable for discrete or continuous $X$, respectively. We may also 
