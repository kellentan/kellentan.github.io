...
I am an Applied Scientist II at Microsoft. My research interests are broadly in NLP, specifically in approaches towards improving model evaluation and data quality. Some areas I have previously worked on include figurative language reasoning, context-aware reasoning, synthetic data & dataset creation, as well as agentic frameworks. I am drawn towards simple, effective, and reproducible approaches that can deepen our understanding and usage of language/foundation models.

I have been fortunate to intern at IBM Research (Summer 2024, Summer 2025) under the mentorship of [Dr. Anna Lisa Gentile](https://anligentile.github.io/), as well as at Samsung Research America (Spring 2025) under the mentorship of [Dr. Ganesh Ramesh](https://ganeshramesh.github.io/). Previously, I received my M.A. and was a PhD candidate (on-leave) in Electrical and Computer Engineering (ECE) at Princeton University. Before that, I received my B.S. in Electrical Engineering at UCLA, where I was grateful to be mentored by [Prof. Fabien Scalzo](https://web.cs.ucla.edu/~fab/). 
